...
public class Busquedas extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namProf=(Button)findViewById(R.id.nameProf);

        namProf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(),NomProf.class);
                startActivity(i);
            }
        });
